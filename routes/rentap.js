...
router.get('/find_in_col/good/:column/:pattern', rentap_controller.search_col_good); //same but exclude rows in trash
router.get('/find_in_col/trash/:column/:pattern', rentap_controller.search_col_trash); //same but only rows in trash
