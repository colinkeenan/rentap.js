...
router.get('/goodnames', rentap_controller.show_goodaps); //list of names not in trash
router.get('/trashnames', rentap_controller.show_trashnames); //list of trashed names
router.get('/:pattern', rentap_controller.search_allaps); //searches every column for pattern and returns matching rows
router.get('/goodaps/:pattern', rentap_controller.search_goodaps); //same but exclude rows in trash
router.get('/trashaps/:pattern', rentap_controller.search_trashaps); //same but only rows in trash
router.get('/:column/:pattern', rentap_controller.search_column); //search only the specified column for pattern and return matching rows
